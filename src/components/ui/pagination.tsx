...
const PaginationPrevious = ({
  ...
  <PaginationLink
    ...
    size="default"
    className={cn("gap-4 pl-12", className)}
    {...props}
  >
...
const PaginationNext = ({
  ...
  <PaginationLink
    ...
    size="default"
    className={cn("gap-4 pr-12", className)}
    {...props}
  >
    <span>Next</span>
...
const PaginationEllipsis = ({ className, ...props }: React.ComponentProps<"span">) => (
  <span
    aria-hidden
    className={cn("flex h-32 w-32 items-center justify-center text-muted-foreground/75", className)}
    {...props}
  >
    <IconDots className="h-16 w-16" />
